...
int qcom_read(struct bootimg *img) {
...
int qcom_write(struct bootimg *img, int fd) {
...
struct variant variant_qcom = {
    .name = "qcom",
    .description = "Qualcomm with appended device tree",
    .read = qcom_read,
    .write = qcom_write,
};
